...
public class DomainUserDetailsServiceImpl implements UserDetailsService {
	...
	@Override
	/*
	 * Accepting the username entered by the user.
	 * Try to fetch the user from the db with the matching username
	 * If the user is not present in the database, throw UsernameNotFoundException.
	 * Throwing the UsernameNotFoundException will result in HTTP 401
	 * 
	 * If the user is present, then return a new DomainUserDetails which is an adaptor
	 */
